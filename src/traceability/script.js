...
const productData = {
    ...
    "Shampoo A": {
        "lotNumber": "shampooA_123",
    },
    "Guar Powder": {
        "lotNumber": "powder_123",
    },
    "Water": {
        "lotNumber": "water_123",
    },
...
function update(source) {
    ...
    const node = svg.selectAll("g.node")
        .data(nodes, function (d) {
            console.log(d); return d.id || (d.id = ++currNodeId);
        });
...
// Toggle children and show details on click.
function click(d) {
    console.log(d.name);
    productDetailView.name.innerText = d.name;
    productDetailView.lotNumber.innerText = productData[d.name].lotNumber;
    if (d.children) {
